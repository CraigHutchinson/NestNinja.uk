...
See [ADR-002](https://github.com/CraigHutchinson/NestNinja.open/blob/main/docs/adr/002-p4-application-host.md) for the full reasoning.
...
- [Our Architecture Decision Records](https://github.com/CraigHutchinson/NestNinja.open/tree/main/docs/adr)

Questions? [Join the discussion on GitHub!](https://github.com/CraigHutchinson/NestNinja.open/discussions)
